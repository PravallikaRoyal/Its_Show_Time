...
const SeatLayout = () =>{
    ...
    return show?(
       ...
       <div className='flex flex-col md:flex-row items-start gap-12
        px-6 md:px-10 lg:px-16 py-30 md:pt-50'> 
        {/* Available Timings */}
        <div className='w-50 bg-primary/10 border border-primary/20 rounded-lg py-10
        ...
        {/* Seats Layout */}
        <div className="flex flex-col items-center mt-0 text-xs text-gray-300">
